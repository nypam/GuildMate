...
-- Print scan progress to the player's chat frame so they know we're working
-- and can keep the window open for the broadcast to complete.

local function _ShowScanStart(message)
    GM:Print("|cff4A90D9GuildMate:|r " .. message)
end

local function _ShowScanComplete(message)
    GM:Print("|cff4A90D9GuildMate:|r |cff5fba47" .. message .. "|r")
end
